// Lapsly — Play Billing (Digital Goods API) + paywall. Loaded after the app.
(function(){'use strict';
const CFG={"key":"lp_ent","event":"lapsly-pro-changed","app":"Lapsly","accent":"#9B90F5","bg":"#111017","p1":"#19171F","line":"#2A2732","ink":"#F1EFF7","mut":"#948FA3","title":"Track as many things as you want","sub":"Unlimited trackers, no limit on what you keep an eye on.","benefits":["<b>Unlimited trackers</b> — plants, filters, meds, anything irregular","Daily gentle reminder notification, no spam","Private — nothing leaves your phone, ever"],"plans":[{"key":"pro_yearly","name":"Annual","price":"$19.99","per":"/yr","tag":"Cancel anytime","hero":true},{"key":"pro_weekly","name":"Weekly","price":"$2.99","per":"/wk","tag":"No commitment"}],"grants":{"pro_yearly":"pro","pro_weekly":"pro"}};
